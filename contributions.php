    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h1>Cultural and Spiritual Contributions</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fas fa-home"></i> Home</a></li>
                        <li class="active">Cultural and Spiritual Contributions</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="single-widget services-list-widget">
                        <div class="content">
                            <ul>
                                ...
                                <li ><a href="eco-friendly.php">Promoting Organic and Eco-Friendly
                                        Practices</a>
                                </li>
                                <li class="current-item"><a href="contributions.php">Cultural and Spiritual Contributions</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Single Widget -->
