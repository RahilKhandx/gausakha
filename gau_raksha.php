    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h1>Cow Protection and Shelter (Gau Raksha) </h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fas fa-home"></i> Home</a></li>
                        <li class="active">Cow Protection and Shelter (Gau Raksha) </li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="single-widget services-list-widget">
                        <div class="content">
                            <ul>
                                ...
                                <li class="current-item"><a href="gau_raksha.php">Cow Protection and Shelter (Gau
                                        Raksha) </a></li>
